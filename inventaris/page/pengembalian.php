            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if($data_d['status_peminjaman']== '1') {
                                            echo"<label class='label label-danger'>Dipinjam</label>";
                                        }else{
                                            echo"<label class='label label-danger'>Dikembalikan</label>";
                                        }
                                        ?>
                                    </td>
                                    <td>
                    ...
                    <!-- <tr>
                        ...
                        <td>
                            <a href="?p=detail_pengembalian" class="tbn btn-sm btn-primary">Konfirmasi</a>
                        </td>
                    </tr> -->
                </tbody>
            </table>
