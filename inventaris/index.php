...
<head>
  ...
  <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    ...
    <body>
      ...
      <!-- Fixed navbar -->
      <nav class="navbar navbar-default navbar-fixed-top" style="margin-bottom: 200px;">
        <div class="container">
...
<div class="footer">
  <p>RIYAN ZAKARIA XII RPL</p>
    ...
    <script type="text/javascript"> $(document).on('click', '#cetak', function() { var tgl_awal = $("#tgl_awal").val(); var tgl_sampai = $("#tgl_sampai").val(); window.open('page/cetak_laporan.php?tgl_awal=' + tgl_awal + "&tgl_sampai=" + tgl_sampai, '_blank'); }); </script>